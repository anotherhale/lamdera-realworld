...
import Evergreen.V14.Api.Article.Filters
import Evergreen.V14.Api.User


type ToBackend
    = SignedOut Evergreen.V14.Api.User.User
    | GetTags_Home_
    | ArticleList_Home_ 
    { filters : Evergreen.V14.Api.Article.Filters.Filters
    , page : Int
    }
    | ArticleFeed_Home_ 
    { page : Int
    ...
    | Oauth2_Login Evergreen.V14.Api.User.User
