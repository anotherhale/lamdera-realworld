...
type alias ToBackend =Evergreen.V14.Bridge.ToBackend
...
type BackendMsg
    ...
    | ArticleCreated Time.Posix (Maybe Evergreen.V14.Api.User.UserFull) Lamdera.ClientId 
    { title : String
    , description : String
    , body : String
    , tags : (List String)
    }
    | ArticleCommentCreated Time.Posix (Maybe Evergreen.V14.Api.User.UserFull) Lamdera.ClientId Evergreen.V14.Api.Article.Slug 
    { body : String
    }
    | NoOpBackendMsg
