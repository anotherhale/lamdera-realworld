...
type alias ToBackend =Evergreen.V2.Bridge.ToBackend
...
type BackendMsg
    ...
    | ArticleCreated Time.Posix (Maybe Evergreen.V2.Api.User.UserFull) Lamdera.ClientId 
    { title : String
    , description : String
    , body : String
    , tags : (List String)
    }
    | ArticleCommentCreated Time.Posix (Maybe Evergreen.V2.Api.User.UserFull) Lamdera.ClientId Evergreen.V2.Api.Article.Slug 
    { body : String
    }
    | NoOpBackendMsg
